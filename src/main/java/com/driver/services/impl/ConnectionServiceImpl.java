...
//        //Connect the user to a vpn by considering the following priority order.
//        //1. If the user is already connected to any service provider, throw "Already connected" exception.
//        //2. Else if the countryName corresponds to the original country of the user, do nothing. This means that the user wants to connect to its original country,
...
//                    getCountry = country;
//                    smallestServiceProviderId = Math.min(serviceProvider.getId(), smallestServiceProviderId);
//                    code = country.getCode();
//                }
//            }
//        }
//
//        if(smallestServiceProviderId == Integer.MAX_VALUE)throw new Exception("Unable to connect");
//
//        ServiceProvider serviceProvider = serviceProviderRepository2.findById(smallestServiceProviderId).get();
//
//        String maskedIp = code + "." + smallestServiceProviderId + "." + userId;
//
...
//    }
    ...
    public User communicate(int senderId, int receiverId) throws Exception {
        ...
        if(receiver.getMaskedIp()!=null){
            ...
            else if(code.equals(CountryName.CHI.toCode())){
